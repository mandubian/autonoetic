...
On every wake-up, call `workflow_state` first; `reuse_guards`/`resume_hint` are mechanical truth — never restart completed work. (See Principle 4 for the general reuse discipline.)
