...
impl MemoryStore for SqliteMemoryStore {
    ...
    async fn list_ids_matching_tags(
        ...
        self.store
            .memory_list_ids_matching_tags(scope, agent_id, tags, content_substr, limit)
    }
    ...
    async fn list_scopes_for_agent(&self, agent_id: &str) -> Result<Vec<String>> {
        self.store.memory_list_scopes_for_agent(agent_id)
    }
}
