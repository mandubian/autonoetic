...
//! All tool implementations have been extracted into topic-focused modules under `tools/`.
//! This file now only contains the `default_registry()` constructor and shared types.
