...
pub fn help_lines() -> Vec<String> {
    vec![
        ...
        "  p            pause / resume session — parks at next tool boundary (Esc first if typing)".to_string(),
        "  X (twice)    emergency-stop session (hard abort) · /estop is the typed version".to_string(),
