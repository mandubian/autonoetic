...
- [x] **6.1** Remove `session_snapshot.rs` if fully replaced by checkpoint. Fork path migrated to `checkpoint::SessionFork`. Old `SessionSnapshot` struct and `SessionSnapshotTool` removed.
