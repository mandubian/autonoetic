...
| [`constitution/`](constitution) | The governance corpus: signed versions, the [law table](constitution/law-table.md) (every clause — who it binds, who may invoke it), the [enforcement register](constitution/enforcement-register.md) (which code holds each one up), signing, key management | reading the law |
