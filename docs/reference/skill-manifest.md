...
(`docs/internals/sandbox/sink-detection.md`), asking the agent to re-declare what the gateway
...
has no network namespace at all (`docs/internals/sandbox/network-grant.md`).
