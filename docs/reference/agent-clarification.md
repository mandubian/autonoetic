...
- [Foundation instructions — workflow layer](../../autonoetic-gateway/src/runtime/foundation_workflow.md) — the clarification rule
- [AGENTS.md](../AGENTS.md) — Delegation contracts and routing rules
- [Separation of Powers](../concepts/separation-of-powers.md) — Agent vs gateway responsibilities
- [Content Store](../internals/storage/content-store.md) — Content handles for previous work references
