...
| `constitution.source_path` | string (path) | `"docs/constitution/versions/2026.06.02/constitution.md"` | Active constitution markdown source used for digest/profile extraction. Relative paths resolve in this order: `agents_dir/<path>`, `agents_dir` parent, current working directory, workspace root fallback. |
| `constitution.lock_path` | string (path) | `"docs/constitution/versions/2026.06.02/gateway-constitution.lock.json"` | Active constitution lock manifest. Startup refuses to boot if lock integrity checks fail. Relative paths resolve in this order: `agents_dir/<path>`, `agents_dir` parent, current working directory, workspace root fallback. |
...
```yaml
constitution:
  source_path: "docs/constitution/versions/2026.06.02/constitution.md"
  lock_path: "docs/constitution/versions/2026.06.02/gateway-constitution.lock.json"
...
```yaml
constitution:
  source_path: ".gateway/constitution/versions/2026.06.02/constitution.md"
  lock_path: ".gateway/constitution/versions/2026.06.02/gateway-constitution.lock.json"
  require_signature: true
  trusted_signers:
    autonoetic:constitution:v1: "lNxT1b/jWa6LqM2Thd7rW1IppvlH3rlEnAOPV81Igzk="
```
