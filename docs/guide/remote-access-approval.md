...
│       docs/reference/capability-grants.md)                        │
...
Grants are cleaned up on session end, emergency stop, or expiry. See [Approval System](../wiki/approval-system.md) for full details including similarity scoring and analytics.
