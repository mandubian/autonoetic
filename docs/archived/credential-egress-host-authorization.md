> **Archived — shipped.** The behaviour this proposed is live and described in [`credentials.md`](../reference/credentials.md). Kept as the design record; not source of truth.
