...
1. **Gateway-triggered**: Analysis runs automatically during revision creation, independent of LLM agents
...
- [AGENTS.md](../AGENTS.md) - Capability types and semantics (canonical reference)
- [Approval System](../wiki/approval-system.md) - Current approval and interaction flow
- [Remote Access Approval](../guide/remote-access-approval.md) - Network access detection
