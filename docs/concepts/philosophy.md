...
precisely in [`docs/reference/principal-seat-capability.md`](../reference/principal-seat-capability.md).)
...
(`docs/concepts/separation-of-powers.md`): reasoning (agents), enforcement
