...
> time. The living rule list is `docs/gateway-constitution.md`; the
...
The full rule table lives in `gateway-constitution.md`.
...
- **R+18** Canonical `docs/gateway-constitution.md` maintained alongside
  code.
