...
- **What the signature covers.** Signing principles + Register *digest* (not the full generated Register text) keeps the ceremony light while still detecting code/law divergence. Confirm this satisfies the federation digest/profile checks (P-10.9).
