...
> | B.2 lessons crystallize into revisions | **SHIPPED** — curator `promote_to_skill` verdicts route through the orchestrator (Step 4b) to the steward, which delegates instruction changes to `agent-factory.default` |
